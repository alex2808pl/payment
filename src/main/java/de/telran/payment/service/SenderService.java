...
public class SenderService {
    ...
    public SenderDto getSenderById(Long id) {
        ...
        if (sender.isPresent()) {
            senderDto = new SenderDto(sender.get().getId(),
                    ...
                    sender.get().getCreatedAt(), sender.get().getUpdatedAt(), null);
        }
        return senderDto;
    }
    ...
    public SenderDto insertSender(SenderDto senderDto) {
        // получаем связанный PurchaseOrder
        PurchaseOrderDto purchaseOrderDto = (PurchaseOrderDto) senderDto.getPurchaseOrder();
        PurchaseOrder purchaseOrder = null;
//        if (purchaseOrderDto != null && purchaseOrderDto) {
//            PurchaseOrder purchaseOrder = purchaseOrderRepository.findById(purchaseOrderDto.getClass());
//        }
...
// трансформируем в Dto
        SenderDto responseSenderDto = new SenderDto(sender.getId(),
                ...
                sender.getCreatedAt(), sender.getUpdatedAt(), null);
